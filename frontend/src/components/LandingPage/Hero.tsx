      ...
      <div className="relative container py-32">
        <header className="mx-auto max-w-3xl text-center">
          <h1 className="font-inter text-5xl font-bold tracking-tight text-foreground md:text-6xl">
            Remember Everything <br /> That Matters
          </h1>
          <p className="my-7 max-w-3xl font-prompt text-md tracking-tight text-muted-foreground md:text-xl">
            Stop losing those "I need to save this" moments. Brainwave keeps
            your digital discoveries organized and accessible when inspiration
            strikes.
          </p>
        </header>
