...
import { Share2, Trash2, Youtube, Twitter, Globe } from "lucide-react";
...
function convertToEmbedURL(url: string, type: string): string {
  ...
  return url; // return original for other types
}
...
export default function ContentCards() {
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="mb-8">
        <h1 className="text-3xl font-bold font-inter mb-2">Content Library</h1>
        <p className="text-muted-foreground font-inter">
          Discover and manage your curated content collection
        </p>
      </div>
            ...
            (
              ...
              >
                <CardHeader className="flex-shrink-0 pb-1">
                  ...
                  <h3 className="font-semibold text-xl line-clamp-2 font-roboto flex-wrap">
                    {card.title}
                  </h3>
                </CardHeader>

                <CardContent className="flex-1 flex flex-col mx-2 px-4 py-1 pt-0">
                  <p className="text-sm text-gray-600 mb-2 line-clamp-3 flex-shrink-0">
                    {card.text}
                  </p>
                  ...
                  <div className="flex-shrink-0 mt-3 pt-3 border-t border-gray-100">
                    <p className="text-xs font-inter text-secondary-foreground">
                      Added on{" "}
